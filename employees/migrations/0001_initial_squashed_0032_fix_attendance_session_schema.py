...
class Migration(migrations.Migration):
    ...
    replaces = [('employees', '0001_initial'), ('employees', '0002_employee_account_number_employee_badge_id_and_more'), ('employees', '0003_locationlog_attendance'), ('employees', '0004_employeeidproof'), ('employees', '0005_employee_profile_picture'), ('employees', '0006_leaverequest_leavebalance'), ('employees', '0007_alter_leaverequest_leave_type'), ('employees', '0008_employee_annual_ctc_payslip'), ('employees', '0009_handbooksection_policysection'), ('employees', '0010_alter_attendance_status'), ('employees', '0011_alter_leaverequest_options_and_more'), ('employees', '0012_employee_location'), ('employees', '0013_remove_employee_shift_and_more'), ('employees', '0014_regularizationrequest'), ('employees', '0015_employee_location_new_alter_employee_location'), ('employees', '0016_remove_employee_location_new_alter_employee_location'), ('employees', '0017_alter_employee_shift_schedule'), ('employees', '0018_attendance_is_grace_used_attendance_is_half_day_late_and_more'), ('employees', '0019_alter_employee_manager'), ('employees', '0020_alter_attendance_options_and_more'), ('employees', '0021_employee_employment_status_employee_exit_date_and_more'), ('employees', '0022_exitinitiative'), ('employees', '0023_employee_week_off_friday_employee_week_off_monday_and_more'), ('employees', '0024_employee_probation_completion_date_jobhistory'), ('employees', '0025_remove_employee_probation_completion_date_and_more'), ('employees', '0026_alter_employee_emergency_contact_emergencycontact'), ('employees', '0027_alter_employee_badge_id'), ('employees', '0028_attendance_daily_clock_count_and_more'), ('employees', '0029_add_missing_earned_leave_fields'), ('employees', '0030_alter_leaverequest_leave_type'), ('employees', '0031_attendance_user_timezone'), ('employees', '0032_fix_attendance_session_schema')]

    dependencies = [
        ('companies', '0007_rename_companies_h_company_f6931c_idx_companies_h_company_a18c66_idx_and_more'),
